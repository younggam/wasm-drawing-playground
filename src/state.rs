...
// 
// static STATE_ENCODED: &[u8] = include_bytes!("../pytorch/candy.pt");
// 
// /// Builds and loads trained parameters into the model.
// pub async fn build_and_load_model() -> TransformerNet<Backend> {
//     #[cfg(feature = "wgpu")]
//     init_setup_async::<AutoGraphicsApi>(&WgpuDevice::default(), Default::default()).await;
// 
//     let model: TransformerNet<Backend> = TransformerNet::new(&Default::default());
